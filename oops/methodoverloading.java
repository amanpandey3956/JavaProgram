public class methodoverloading {
    ...
    /*
     * Method Overloading:  
     * It refers to the concept of having more than one methods with the same name but  different parameters in a Java program. 
     * In java, we can have two methods with the same name but different parameters.  
     * This concept of having more than one method with the same name in a single class 
     * is known as method overloading. It helps to provide flexibility and avoid naming conflicts.
     */
